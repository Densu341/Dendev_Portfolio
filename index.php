...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#home">Deni Irawan</a>
  ...
  <div class="jumbotron" id="home">
    <div class="container">
      <div class="text-center">
        ...
        <h1 class="display-4">Deni Irawan</h1>
      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          <div class="row">
            ...
            <div class="col-md-8">
              <h5><?= $youtubeNickname; ?></h5>
              <p><?= $youtubeSubscriber; ?> Subscribers</p>
              <div class="g-ytsubscribe" data-channelid="UCitLJuqeGibLupUbEoDcqIA" data-layout="default" data-count="hidden"></div>
            </div>
          </div>
